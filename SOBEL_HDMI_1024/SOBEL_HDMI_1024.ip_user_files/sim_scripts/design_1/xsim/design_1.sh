...
# Set xvlog options
xvlog_opts="--incr --relax -L axi_vip_v1_1_12 -L processing_system7_vip_v1_0_14 -L smartconnect_v1_0 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L xlslice_v1_0_2 -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_28 -L proc_sys_reset_v5_0_13 -L v_tc_v6_2_4 -L xlconcat_v2_1_4 -L xlconstant_v1_1_7 -L lib_pkg_v1_0_2 -L axi_iic_v2_1_2 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_ddf0.protoinst" -protoinst "protoinst_files/bd_3a92.protoinst" -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/bd_88fd.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
