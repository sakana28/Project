...
module bd_3a92_csc_0_hls_deadlock_idx0_monitor ( // for module bd_3a92_csc_0_v_csc_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[5] = idx5_block & (1'b0 | axis_block_sigs[-1]);
...
// instant sub module
 bd_3a92_csc_0_hls_deadlock_idx1_monitor bd_3a92_csc_0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
