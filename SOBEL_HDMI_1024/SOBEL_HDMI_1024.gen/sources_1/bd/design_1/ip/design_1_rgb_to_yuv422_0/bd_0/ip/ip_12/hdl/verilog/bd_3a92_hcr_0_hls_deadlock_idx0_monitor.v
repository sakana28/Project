...
module bd_3a92_hcr_0_hls_deadlock_idx0_monitor ( // for module bd_3a92_hcr_0_v_hcresampler_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[0] = idx1_block & (1'b0 | axis_block_sigs[-1] | axis_block_sigs[-1] | axis_block_sigs[-1]);
assign process_idle_vec[0] = inst_idle_sigs[0];
assign process_chan_block_vec[0] = inst_block_sigs[0];
assign process_axis_block_vec[1] = 1'b0;
assign process_idle_vec[1] = inst_idle_sigs[1];
assign process_chan_block_vec[1] = inst_block_sigs[1];
assign process_axis_block_vec[2] = idx5_block & (1'b0 | axis_block_sigs[-1]);
...
// instant sub module
 bd_3a92_hcr_0_hls_deadlock_idx1_monitor bd_3a92_hcr_0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
