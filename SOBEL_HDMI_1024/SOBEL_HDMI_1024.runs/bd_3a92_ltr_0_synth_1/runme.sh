...
HD_PWD='/home/benchmarker/FPGAProject/SOBEL_HDMI_1024/SOBEL_HDMI_1024.runs/bd_3a92_ltr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_3a92_ltr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_3a92_ltr_0.tcl
