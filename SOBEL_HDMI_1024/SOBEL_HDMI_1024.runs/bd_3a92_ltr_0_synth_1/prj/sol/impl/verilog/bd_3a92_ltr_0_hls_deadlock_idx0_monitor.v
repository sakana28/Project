...
module bd_3a92_ltr_0_hls_deadlock_idx0_monitor ( // for module bd_3a92_ltr_0_v_letterbox_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 bd_3a92_ltr_0_hls_deadlock_idx1_monitor bd_3a92_ltr_0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
