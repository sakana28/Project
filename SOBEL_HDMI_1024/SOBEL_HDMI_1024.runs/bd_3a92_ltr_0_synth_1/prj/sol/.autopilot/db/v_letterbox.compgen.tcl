...
# FIFO definition: 
set ID 110
set FifoName bd_3a92_ltr_0_fifo_w24_d16_S
...
# FIFO definition: 
set ID 112
set FifoName bd_3a92_ltr_0_start_for_v_letterbox_core_U0
set InstName start_for_v_letterbox_core_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 2
...
# FIFO definition: 
set ID 113
set FifoName bd_3a92_ltr_0_start_for_MultiPixStream2AXIvideo_U0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 114 \
			corename v_letterbox_CTRL_axilite \
			name bd_3a92_ltr_0_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bd_3a92_ltr_0_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
