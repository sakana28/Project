...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("m_axis_video_TDATA", 24, hls_out, 17, "axis", "out_data", 1),
	Port_Property("m_axis_video_TKEEP", 3, hls_out, 18, "axis", "out_data", 1),
	Port_Property("m_axis_video_TSTRB", 3, hls_out, 19, "axis", "out_data", 1),
	Port_Property("m_axis_video_TUSER", 1, hls_out, 20, "axis", "out_data", 1),
	Port_Property("m_axis_video_TLAST", 1, hls_out, 21, "axis", "out_data", 1),
	Port_Property("m_axis_video_TID", 1, hls_out, 22, "axis", "out_data", 1),
	Port_Property("m_axis_video_TDEST", 1, hls_out, 23, "axis", "out_data", 1),
	Port_Property("s_axis_video_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("s_axis_video_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
	Port_Property("m_axis_video_TVALID", 1, hls_out, 23, "axis", "out_vld", 1),
	Port_Property("m_axis_video_TREADY", 1, hls_in, 23, "axis", "out_acc", 1),
};
const char* HLS_Design_Meta::dut_name = "v_letterbox";
