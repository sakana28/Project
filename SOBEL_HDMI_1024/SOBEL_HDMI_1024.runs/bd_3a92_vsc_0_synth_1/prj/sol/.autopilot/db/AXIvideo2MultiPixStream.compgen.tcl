...
eval "cg_default_interface_gen_dc { \
    id 62 \
    name HwReg_Width_c13 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_Width_c13 \
    op interface \
    ports { HwReg_Width_c13_din { O 11 vector } HwReg_Width_c13_num_data_valid { I 2 vector } HwReg_Width_c13_fifo_cap { I 2 vector } HwReg_Width_c13_full_n { I 1 bit } HwReg_Width_c13_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 63
set RegSliceName bd_3a92_vsc_0_regslice_both
set RegSliceInstName bd_3a92_vsc_0_regslice_both_U
set CoreName ap_simcore_bd_3a92_vsc_0_regslice_both
