...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("m_axis_video_TDATA", 24, hls_out, 15, "axis", "out_data", 1),
	Port_Property("m_axis_video_TKEEP", 3, hls_out, 16, "axis", "out_data", 1),
	Port_Property("m_axis_video_TSTRB", 3, hls_out, 17, "axis", "out_data", 1),
