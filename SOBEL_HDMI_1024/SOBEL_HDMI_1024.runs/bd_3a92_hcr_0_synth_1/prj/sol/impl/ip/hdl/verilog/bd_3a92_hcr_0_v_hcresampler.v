...
(* CORE_GENERATION_INFO="bd_3a92_hcr_0_v_hcresampler,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=5.625000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=5.132000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2372,HLS_SYN_LUT=2532,HLS_VERSION=2022_1}" *)
...
wire    v_hcresampler_core_U0_srcYUV_read;
wire   [23:0] v_hcresampler_core_U0_outYUV_din;
wire    v_hcresampler_core_U0_outYUV_write;
...
bd_3a92_hcr_0_fifo_w24_d16_S srcYUV_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (v_hcresampler_core_U0_ap_idle & MultiPixStream2AXIvideo_U0_ap_idle & AXIvideo2MultiPixStream_U0_ap_idle);
...
`include "bd_3a92_hcr_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "bd_3a92_hcr_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //bd_3a92_hcr_0_v_hcresampler
