...
set Library     "ip"
set IPName      "v_hcresampler"
set Version     "1.1"
set DisplayName "V_hcresampler"
set Revision    "2112658651"
...
set xo_kernel_name "v_hcresampler"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/benchmarker/FPGAProject/SOBEL_HDMI_1024/SOBEL_HDMI_1024.runs/bd_3a92_hcr_0_synth_1/prj/sol"
set debug_dir "/home/benchmarker/FPGAProject/SOBEL_HDMI_1024/SOBEL_HDMI_1024.runs/bd_3a92_hcr_0_synth_1/prj/sol/.debug"
set xo_hls_files_dir ""
set hdl_module_list {bd_3a92_hcr_0_flow_control_loop_pipe_sequential_init
bd_3a92_hcr_0_flow_control_loop_pipe_sequential_init
bd_3a92_hcr_0_flow_control_loop_pipe_sequential_init
...
## Variables
set Top "bd_3a92_hcr_0_v_hcresampler"
set TopNoPrefix "v_hcresampler"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST R 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST R 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 width W 0x0 "Data signal of width" {{0 16 width W 0 "Bit 15 to 0 of width"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 height W 0x0 "Data signal of height" {{0 16 height W 0 "Bit 15 to 0 of height"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 input_video_format W 0x0 "Data signal of input_video_format" {{0 8 input_video_format W 0 "Bit 7 to 0 of input_video_format"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 output_video_format W 0x0 "Data signal of output_video_format" {{0 8 output_video_format W 0 "Bit 7 to 0 of output_video_format"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 coefs_0_0 W 0x0 "Data signal of coefs_0_0" {{0 16 coefs_0_0 W 0 "Bit 15 to 0 of coefs_0_0"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 coefs_0_1 W 0x0 "Data signal of coefs_0_1" {{0 16 coefs_0_1 W 0 "Bit 15 to 0 of coefs_0_1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 coefs_0_2 W 0x0 "Data signal of coefs_0_2" {{0 16 coefs_0_2 W 0 "Bit 15 to 0 of coefs_0_2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 coefs_0_3 W 0x0 "Data signal of coefs_0_3" {{0 16 coefs_0_3 W 0 "Bit 15 to 0 of coefs_0_3"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 coefs_1_0 W 0x0 "Data signal of coefs_1_0" {{0 16 coefs_1_0 W 0 "Bit 15 to 0 of coefs_1_0"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 coefs_1_1 W 0x0 "Data signal of coefs_1_1" {{0 16 coefs_1_1 W 0 "Bit 15 to 0 of coefs_1_1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 coefs_1_2 W 0x0 "Data signal of coefs_1_2" {{0 16 coefs_1_2 W 0 "Bit 15 to 0 of coefs_1_2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 coefs_1_3 W 0x0 "Data signal of coefs_1_3" {{0 16 coefs_1_3 W 0 "Bit 15 to 0 of coefs_1_3"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 5.625 machine 64 combinational 0 latency 178227 II x}
