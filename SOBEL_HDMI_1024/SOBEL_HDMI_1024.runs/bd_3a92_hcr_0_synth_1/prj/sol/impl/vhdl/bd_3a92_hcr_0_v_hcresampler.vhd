...
architecture behav of bd_3a92_hcr_0_v_hcresampler is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "bd_3a92_hcr_0_v_hcresampler,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=5.625000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=5.132000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2372,HLS_SYN_LUT=2532,HLS_VERSION=2022_1}";
    ...
    signal v_hcresampler_core_U0_srcYUV_read : STD_LOGIC;
    signal v_hcresampler_core_U0_outYUV_din : STD_LOGIC_VECTOR (23 downto 0);
    signal v_hcresampler_core_U0_outYUV_write : STD_LOGIC;
    ...
    signal start_for_v_hcresampler_core_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_v_hcresampler_core_U0_full_n : STD_LOGIC;
    signal start_for_v_hcresampler_core_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_v_hcresampler_core_U0_empty_n : STD_LOGIC;
    ...
    component bd_3a92_hcr_0_AXIvideo2MultiPixStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component bd_3a92_hcr_0_v_hcresampler_core IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component bd_3a92_hcr_0_MultiPixStream2AXIvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component bd_3a92_hcr_0_fifo_w24_d16_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component bd_3a92_hcr_0_start_for_v_hcresampler_core_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_3a92_hcr_0_start_for_MultiPixStream2AXIvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_3a92_hcr_0_CTRL_s_axi IS
    generic (
...
begin
    CTRL_s_axi_U : component bd_3a92_hcr_0_CTRL_s_axi
    generic map (
    ...
    port map (
        ...
        width => width,
        height => height,
        input_video_format => input_video_format,
    ...
    AXIvideo2MultiPixStream_U0 : component bd_3a92_hcr_0_AXIvideo2MultiPixStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    v_hcresampler_core_U0 : component bd_3a92_hcr_0_v_hcresampler_core
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ...
        srcYUV_read => v_hcresampler_core_U0_srcYUV_read,
        height => height,
        width => width,
        input_video_format => input_video_format,
        output_video_format => output_video_format,
        ...
        coefs_1_2 => coefs_1_2,
        coefs_1_3 => coefs_1_3,
        outYUV_din => v_hcresampler_core_U0_outYUV_din,
        outYUV_num_data_valid => outYUV_num_data_valid,
        outYUV_fifo_cap => outYUV_fifo_cap,
        outYUV_full_n => outYUV_full_n,
        outYUV_write => v_hcresampler_core_U0_outYUV_write);

    MultiPixStream2AXIvideo_U0 : component bd_3a92_hcr_0_MultiPixStream2AXIvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    srcYUV_U : component bd_3a92_hcr_0_fifo_w24_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        ...
        if_read => v_hcresampler_core_U0_srcYUV_read);

    outYUV_U : component bd_3a92_hcr_0_fifo_w24_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => v_hcresampler_core_U0_outYUV_din,
        if_full_n => outYUV_full_n,
        if_write => v_hcresampler_core_U0_outYUV_write,
        if_dout => outYUV_dout,
    ...
    start_for_v_hcresampler_core_U0_U : component bd_3a92_hcr_0_start_for_v_hcresampler_core_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2AXIvideo_U0_U : component bd_3a92_hcr_0_start_for_MultiPixStream2AXIvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= MultiPixStream2AXIvideo_U0_ap_done;
    ap_idle <= (v_hcresampler_core_U0_ap_idle and MultiPixStream2AXIvideo_U0_ap_idle and AXIvideo2MultiPixStream_U0_ap_idle);
    ap_ready <= AXIvideo2MultiPixStream_U0_ap_ready;
    ...
    start_for_v_hcresampler_core_U0_din <= (0=>ap_const_logic_1, others=>'-');
    v_hcresampler_core_U0_ap_continue <= ap_const_logic_1;
    v_hcresampler_core_U0_ap_start <= start_for_v_hcresampler_core_U0_empty_n;
end behav;
