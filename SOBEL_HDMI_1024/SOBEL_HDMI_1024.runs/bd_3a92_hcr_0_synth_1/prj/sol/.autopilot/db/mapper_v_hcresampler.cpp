...
extern "C" void v_hcresampler(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, short, short, char, char, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
auto* sm_axis_video_V_dest_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_m_axis_video_V_dest_V);
  // DUT call
  v_hcresampler(ss_axis_video_V_data_V->data<int>(), ss_axis_video_V_keep_V->data<char>(), ss_axis_video_V_strb_V->data<char>(), ss_axis_video_V_user_V->data<char>(), ss_axis_video_V_last_V->data<char>(), ss_axis_video_V_id_V->data<char>(), ss_axis_video_V_dest_V->data<char>(), __xlx_apatb_param_width, __xlx_apatb_param_height, __xlx_apatb_param_input_video_format, __xlx_apatb_param_output_video_format, __xlx_apatb_param_coefs_0_0, __xlx_apatb_param_coefs_0_1, __xlx_apatb_param_coefs_0_2, __xlx_apatb_param_coefs_0_3, __xlx_apatb_param_coefs_1_0, __xlx_apatb_param_coefs_1_1, __xlx_apatb_param_coefs_1_2, __xlx_apatb_param_coefs_1_3, sm_axis_video_V_data_V->data<int>(), sm_axis_video_V_keep_V->data<char>(), sm_axis_video_V_strb_V->data<char>(), sm_axis_video_V_user_V->data<char>(), sm_axis_video_V_last_V->data<char>(), sm_axis_video_V_id_V->data<char>(), sm_axis_video_V_dest_V->data<char>());
